				...
				<scroll-view scroll-x class="scrollimg">
					<view class="imgs">
						<block v-for="(item,index) in myClassify" :key="index">
							<image class="imgsmall" :src="item.img"></image>
						</block>
					</view>
				</scroll-view>
				<view class="edit" @click="editClassify()">编辑</view>
			</view>
		</view>
...
<script setup lang="ts">
	...
	const toedit=()=> {
		uni.navigateTo({
			url: '/pages/classes/classedit'
		})
	}
	
	const dataarry=ref([
		{name:"服务预约",data:[
			{img:"/static/images/classify/my-service.png",name:"我的服务"},
			{img:"/static/images/classify/subscribe-visit.png",name:"预约访问"},
			{img:"/static/images/classify/device-in.png",name:"设备迁入"},
			{img:"/static/images/classify/device-out.png",name:"设备迁出"},
			{img:"/static/images/classify/audit-report.png",name:"审计报告"}
		]},
		{name:"自助查询",data:[
			{img:"/static/images/classify/resource-query.png",name:"资源查询"},
		]}
	])
